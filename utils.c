...
static uint16_t primes[] = {
	11,   23,    43,    59,    71,    97,
	113,  149,   173,   193,   239,   277,
	307,  353,   401,   457,   523,   593,
	659,  769,   1009,  1543,  3079,  4561,
	6151, 7919,  12289, 24593, 49193, 65521,
};
...
int gladLoadGL(void)
{
	...
	if (opengl)
	{
		...
		if ((glad_glGetString          = load(name = "glGetString"))
		 ...
		 && (glad_glDepthRangef        = load(name = "glDepthRangef"))
